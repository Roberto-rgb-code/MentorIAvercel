...
// Nota:
// - Evitamos "import * as THREE from 'three'" para que compile aunque no existan los tipos.
// - Cargamos 'three' dinámicamente dentro de useEffect del componente de partículas.
    ...
    (async () => {
      ...
      cleanup = () => {
        ...
        particleSystems.forEach((system) => {
          ...
          if (system.material) {
            // material puede ser un array o único
...
const DiagnosticCard: React.FC<{
  ...
  return (
    <div
      ...
      style={{
        boxShadow: isHovered
          ? `0 25px 50px -12px ${glowColor}40, 0 0 40px ${glowColor}20`
          : '0 10px 30px rgba(0,0,0,0.3)'
      }}
    >
      {/* Efecto de brillo animado */}
      <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent opacity-0 group-hover:opacity-100 transform -translate-x-full group-hover:translate-x-full transition-all duration-1000" />
      ...
      <div className="relative p-8 pt-16 text-white h-full flex flex-col">
        ...
        <div className="flex-grow">
          ...
          <p className="text-sm leading-relaxed opacity-90 mb-8 text-white">{description}</p>
        </div>
...
const Diagnostico: React.FC = () => {
  ...
  const diagnosticOptions = [
    {
      ...
      subtitle: 'Emergencia',
      description:
        'Respuesta inmediata para crisis empresariales. Identifica problemas críticos y obtén soluciones urgentes para estabilizar tu negocio en tiempo récord.',
    ...
    },
    {
      ...
      subtitle: 'General',
      description:
        'Evaluación integral y estratégica de tu negocio. Descubre fortalezas ocultas, identifica oportunidades de crecimiento y establece un plan de acción sostenible.',
      icon: <FaUserTie />,
    ...
    },
    {
      ...
      subtitle: 'Profundo',
      description:
        'Análisis exhaustivo de nivel empresarial. Sumérgete en cada aspecto de tu organización con metodologías avanzadas y obtén insights de alto valor estratégico.',
      icon: <FaBuilding />,
      secondaryIcon: <FaGem />,
      accentIcon: <FaCog />,
  ...
  return (
    <PrivateLayout>
      ...
      {/* Overlays */}
      <div className="fixed inset-0 bg-gradient-to-br from-pink-50/60 via-blue-50/40 to-green-50/50 z-0" />
      <div className="fixed inset-0 bg-gradient-to-t from-purple-50/70 via-transparent to-indigo-50/60 z-0" />
          ...
          <div className="bg-gradient-to-r from-white/70 via-white/80 to-white/70 backdrop-blur-lg rounded-3xl p-10 shadow-2xl border border-white/50">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 text-lg">
                Si no estás seguro, el <strong className="text-indigo-600">Diagnóstico General</strong>{' '}
